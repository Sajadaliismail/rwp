...
export const metadata: Metadata = {
  title:
    "Wooden Pallet Products - Premium Quality Pallets, Boxes & Crates | Royal Wood Packers",
  description:
  ...
  openGraph: {
    title:
      "Wooden Pallet Products - Premium Quality Pallets & Packaging Solutions",
    description:
...
export default function ProductsPage() {
  const products = [
    ...
    },
    {
      ...
      keywords:
        "painted wooden pallets, weather resistant pallets, moisture proof pallets",
    },
    {
    ...
    },
    {
      ...
      keywords:
        "wooden planks, pallet manufacturing, wooden packaging materials",
    },
    {
      id: "plywood",
      name: "Plywood Sheets",
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="hidden md:block">
                  ...
                  <p className="text-sm text-blue-400 font-semibold tracking-wider">
                    Premium Wooden Pallet Products
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl animate-fade-in-delayed">
                Discover Royal Wood Packers' comprehensive range of wooden
                packaging products designed to meet various industrial, export,
                and commercial needs. Each wooden pallet and packaging solution
                is crafted with precision using premium materials and built to
                exceed international quality standards.
              </p>
            </div>
            ...
            <div className="mb-12 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-center text-white animate-fade-in-up">
              ...
              <h2 className="text-3xl font-bold mb-4">
                Get Instant Wooden Pallet Price Estimates
              </h2>
              <p className="text-xl mb-6 text-blue-100">
                Use our advanced wooden pallet calculator to get accurate
                pricing for pallets, boxes, and crates based on your specific
              ...
              >
                <Link href="/get-rates">
                  Calculate Wooden Pallet Prices Now
                </Link>
              </Button>
            </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Eco-friendly wooden pallet recycling and refurbishment services",
                  },
                  {
                    name: "Pallet Repair Services",
                    description:
                      "Professional wooden pallet repair and maintenance services",
                  },
                  {
                    name: "Custom Wooden Pallet Design",
                    description:
                      "Tailored wooden pallet solutions for specific industry needs",
                  },
                  {
                    name: "Logistics & Packaging Solutions",
                    description:
                      "Complete wooden packaging and logistics support services",
                  },
                ].map((service, index) => (
                  <Card
                    key={index}
            ...
            <div className="mt-16 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-center text-white">
              <h2 className="text-3xl font-bold mb-4">
                Need Custom Wooden Packaging Solutions?
              </h2>
              <p className="text-xl mb-6 text-blue-100">
                We specialize in creating custom wooden pallets, boxes, and
                packaging solutions tailored to your specific industry
                requirements and dimensions
              </p>
              <Button
                size="lg"
              ...
              >
                <Link href="/contact">
                  Discuss Custom Wooden Packaging Solutions
                </Link>
              </Button>
            </div>
          </div>
